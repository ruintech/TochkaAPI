...
public record ReceiptItemResponseModel(
        @JsonProperty("vatType") VatTypeHistorical vatType,
    ...
    /** Builder for {@link ReceiptItemResponseModel}. */
    ...
    public static final class Builder {
        ...
        private VatTypeHistorical vatType;
        private String name;
        ...
        /** Ставка НДС */
        public Builder vatType(VatTypeHistorical vatType) {
        ...
        public ReceiptItemResponseModel build() {
            return new ReceiptItemResponseModel(
                    this.vatType,
                    this.name,
                    this.amount,
                    this.quantity,
