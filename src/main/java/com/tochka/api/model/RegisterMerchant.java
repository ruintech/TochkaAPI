 ...
 * RegisterMerchant
 *
 * @param address Юридический адрес. Например: "УЛИЦА ТАТАРСКАЯ Б. ДОМ 11"
 ...
 * @param zipCode Индекс. Например: "115184"
 ...
 * @param scenario Сценарий использования ТСП. Например: "C2B" (необязательное)
 * @param salesMode Способ торговли ТСП. Например: "REMOTE" (необязательное)
 */
...
public record RegisterMerchant(
    ...
    /** Строитель {@link RegisterMerchant}. */
    ...
    public static final class Builder {
        ...
        /** Сценарий использования ТСП. Например: "C2B" */
        public Builder scenario(ScenarioEnum scenario) {
            this.scenario = scenario;
            return this;
        }

        /** Способ торговли ТСП. Например: "REMOTE" */
