 ...
 *        ТСП. Например: "https://tsp.ru/path" (необязательное)
 * @param takeTax Taketax. Наличие НДС
 * @param totalTaxAmount Totaltaxamount. Сумма НДС в копейках (необязательное)
 * @param uip Уникальный идентификатор платежа, назначаемый получателем (необязательное)
 */
...
public record B2BQrCode(
    ...
    public static final class Builder {
        ...
        ТСП. Например: "https://tsp.ru/path" */
