 ...
 * @param paymentType Тип оплаты. Присутствует, если оплата произведена. Например: "card" (необязательное)
 ...
 * @param paymentMode Способ оплаты. Например: ["sbp", "card", "tinkoff", "dolyame"] (необязательное)
 ...
 * @param items Список товаров в заказе (необязательное)
 ...
 * @param paidAt Дата и время оплаты (необязательное)
...
public record AcquiringGetPaymentOperationListItemModel(
    ...
    /** Строитель {@link AcquiringGetPaymentOperationListItemModel}. */
    ...
    public static final class Builder {
        ...
        /** Тип оплаты. Присутствует, если оплата произведена. Например: "card" */
