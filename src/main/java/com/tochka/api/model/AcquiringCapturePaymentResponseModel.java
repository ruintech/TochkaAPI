...
public record AcquiringCapturePaymentResponseModel(
    ...
    public static final class Builder {
        ...
        public AcquiringCapturePaymentResponseModel build() {
            return new AcquiringCapturePaymentResponseModel(this.data, this.links, this.meta);
        }
    }
}
