 ...
 * Webhook
 *
 * @param webhooksList Список событий, на которое подписано приложение. Например: ["incomingPayment"]
...
public record Webhook(
    ...
    public static final class Builder {
        ...
        /** Список событий, на которое подписано приложение. Например: ["incomingPayment"] */
