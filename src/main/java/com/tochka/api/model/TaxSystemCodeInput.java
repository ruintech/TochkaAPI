 ...
 */
public enum TaxSystemCodeInput {
    ...
    TaxSystemCodeInput(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static TaxSystemCodeInput fromValue(String value) {
        if (value == null) {
            return null;
        }
        for (TaxSystemCodeInput candidate : values()) {
    ...
    public static TaxSystemCodeInput parse(String value) {
        TaxSystemCodeInput parsed = fromValue(value);
        if (parsed == null) {
            throw new IllegalArgumentException(
                    "Неизвестное значение TaxSystemCodeInput: " + value);
        }
        return parsed;
    }
