...
public record ConsentResponseModel(
        ...
        @JsonProperty("permissions") List<ConsentTypeEnum> permissions,
    ...
    public static final class Builder {
        ...
        private List<ConsentTypeEnum> permissions;
        ...
        /** Isvalid. Показывает истек срок разрешения или нет */
        public Builder isValid(Boolean isValid) {
            this.isValid = isValid;
            return this;
        }

        public ConsentResponseModel build() {
            return new ConsentResponseModel(
                    this.status,
