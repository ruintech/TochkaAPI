...
public record AcquiringGetPaymentOperationInfoResponseDataModel(
    ...
    /** Builder for {@link AcquiringGetPaymentOperationInfoResponseDataModel}. */
    ...
    public static final class Builder {
        ...
        public AcquiringGetPaymentOperationInfoResponseDataModel build() {
            return new AcquiringGetPaymentOperationInfoResponseDataModel(this.data, this.links, this.meta);
        }
    }
}
