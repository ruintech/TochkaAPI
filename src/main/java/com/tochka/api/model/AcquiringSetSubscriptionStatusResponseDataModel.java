...
public record AcquiringSetSubscriptionStatusResponseDataModel(
        @JsonProperty("Data") BooleanResponse data,
        @JsonProperty("Links") LinkModel links,
        @JsonProperty("Meta") MetaModel meta) {

    /** Builder for {@link AcquiringSetSubscriptionStatusResponseDataModel}. */
    ...
    public static final class Builder {
        ...
        public AcquiringSetSubscriptionStatusResponseDataModel build() {
            return new AcquiringSetSubscriptionStatusResponseDataModel(this.data, this.links, this.meta);
        }
    }
}
